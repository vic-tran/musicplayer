...
/* ProgressCircle made to show current track. Using clipath to house two different circles. 
inner circle contains image taken from track that is being currently played */
  ...
  return (
    <div className="progress-circle flex">
        <svg width={size} height={size}>
            <g>
                <Circle strokeWidth={"0.4rem"} color="#3B4F73" stroke size={size} />
            ...
            <image 
                ...
                width={2*((size/2) - 30)} 
                height={2*((size/2) - 30)} 
                href="https://pngimg.com/uploads/vinyl/small/vinyl_PNG37.png"
